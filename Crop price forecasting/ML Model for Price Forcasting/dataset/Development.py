...
daily_Data= pd.read_excel("Paddy(Dhan)(Common).xlsx")
df=daily_Data.copy()
...
# basicAuth = 'admin' + ':' + 'Smarter@1234'
# message_bytes = basicAuth.encode('ascii')
# base64_bytes = base64.b64encode(message_bytes)
# base64_message = base64_bytes.decode('ascii')
# basicAuth = "Basic " + base64_message

myurl = 'http://localhost:8080/cpp/file/'
files = {'file': open('file.json', 'rb')}
cropname = input("Enter Crop Name") 
data = {"uploaded_by":"Prathik N","cropname":cropname}
